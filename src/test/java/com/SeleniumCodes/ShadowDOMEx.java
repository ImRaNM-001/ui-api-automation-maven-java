...
//        js.executeScript(valueByJS, passWord);
    ...
    public void chromeDownloads() throws InterruptedException {
        ...
        js.executeScript("arguments[0].value='I succeeded in sending text to Downloads search button'", searchBtn);                 // sending keys to search button of Chrome Downloads hi there
        //Thread.sleep(3000);
    }
